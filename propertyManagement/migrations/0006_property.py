...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('propertyManagement', '0005_delete_property'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saleFactorFile', models.FileField(blank=True, null=True, upload_to='')),
                ('insurancePaperFile', models.FileField(blank=True, null=True, upload_to='')),
                ('carCardFile', models.FileField(blank=True, null=True, upload_to='')),
                ('greenCardFile', models.FileField(blank=True, null=True, upload_to='')),
                ('gasCardFile', models.FileField(blank=True, null=True, upload_to='')),
            ],
        ),
    ]
