...
class Property(models.Model):
    ...
    type_item = models.CharField("نوع آِیتم", default='', max_length=50, blank=True, null=True)
    inventory = models.CharField("انبار", default='', max_length=50, blank=True, null=True)
    dst_inventory = models.CharField("انبار مقصد", default='', max_length=50, blank=True, null=True)
    ...
    number_type = models.CharField("نوع شماره خط", max_length=100, blank=True, null=True)
    number = models.CharField("شماره خط", default='', max_length=50, blank=True, null=True)
    year_buy = models.IntegerField("سال خرید", default='', blank=True, null=True)
    ...
    year_made = models.IntegerField("سال ساخت", default='', blank=True, null=True)
    ...
    description = models.TextField('شرح وضعیت انتقال',default='', max_length=50, blank=True, null=True)
...
class AutoIncrementPropertyFactor(models.Model):
...
class AutoIncrementProperty(models.Model):
    increment = models.BigIntegerField("شمارنده", blank=True, null=True)
    inventory = models.CharField("انبار", max_length=50, blank=True, null=True)
    name = models.CharField("نام اموال", max_length=50, blank=True, null=True)
